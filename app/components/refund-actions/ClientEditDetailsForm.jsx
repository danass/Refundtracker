...
export default function ClientEditDetailsForm({ requestData, actorName }) {
  const initialState = { message: null, error: null, success: false, noChanges: false };
  const [state, formAction, isPending] = useActionState(clientUpdateDetailsAction, initialState);
